...
- [dtable-api-gateway.conf](https://admin.seatable.com/configuration/components/dtable-api-gateway/) (**from** version 5.3)
- [dtable_server_config.json](https://admin.seatable.com/configuration/components/dtable-server/) - (before version 5.3)
- [dtable-db.conf](https://admin.seatable.com/configuration/components/dtable-db/) (before version 5.3)
- [dtable_web_settings.py](https://admin.seatable.com/configuration/components/dtable-web/) (before version 5.3)
